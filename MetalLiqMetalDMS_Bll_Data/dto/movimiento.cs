...
{
	#region movimiento object

	[DataContract]
	public partial class movimiento : IDTOObject
	{
		/// <summary>
		/// Default constructor
		/// </summary>
		...
		private movimiento m_oldmovimiento;
		public void GenerateUndo()
		{
			m_oldmovimiento=new movimiento();
		...
		public string[] FieldChanged()
		{
			...
			//if (m_oldmovimiento.base != m_base) fields.Add("base");
			...
			if (m_oldmovimiento.ID_CRUCE != m_ID_CRUCE) fields.Add("ID_CRUCE");
		...
		// Field for storing the reference to cruce_conciliacion accessed by ID_CRUCE
		private cruce_conciliacion m_cruce_conciliacion;
		...
		/// <summary>
		/// Attribute for access the movimiento's ID_CRUCE value (int)
		/// </summary>
		[DataMember]
		public int? ID_CRUCE
		{
			get { return m_ID_CRUCE; }
			set
			{
				m_changed=true;
				m_ID_CRUCE = value;

				if ((m_cruce_conciliacion != null) && (m_cruce_conciliacion.id != m_ID_CRUCE))
				{
					// we need to reset the reference because it is now invalid
					m_cruce_conciliacion = null;
				}
			}
		}
		...
		{
			return movimientoController.Instance.GetMethodType(pattribute, this);
		}
	...
	#region movimientoList object

	/// <summary>
	/// Class for reading and access a list of movimiento object
	/// </summary>
	[CollectionDataContract]
	public partial class movimientoList : List<movimiento>
	{

		/// <summary>
		/// Default constructor
		/// </summary>
		public movimientoList()
		{
		}
	}
