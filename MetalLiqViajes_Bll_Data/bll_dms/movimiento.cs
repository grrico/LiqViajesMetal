...
namespace LiqViajes_Bll_Data
{
	...
	public partial class movimientoController//: ILatinodeController
	{
		...
		public void Update(string cuenta, int centro, decimal nit, DateTime fec, decimal valor, int? documento, string explicacion, string concilio, short? concepto_mov, short? concilio_ano, int? secuencia_extracto, int? ano_concilia, int? mes_concilia, int? ID_CRUCE, string TIPO_CRUCE, decimal valor_niif, string tipo, int numero, int seq, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				movimientoDataProvider.Instance.Update(cuenta, centro, nit, fec, valor, documento, explicacion, concilio, concepto_mov, concilio_ano, secuencia_extracto, ano_concilia, mes_concilia, ID_CRUCE, TIPO_CRUCE, valor_niif, tipo, numero, seq,"movimiento",datosTransaccion);
			}
			catch (Exception ex)
			{
				throw ex;
		...
		{
			Update(movimiento.cuenta, movimiento.centro, movimiento.nit, movimiento.fec, movimiento.valor, movimiento.documento, movimiento.explicacion, movimiento.concilio, movimiento.concepto_mov, movimiento.concilio_ano, movimiento.secuencia_extracto, movimiento.ano_concilia, movimiento.mes_concilia, movimiento.valor_niif, movimiento.tipo, movimiento.numero, movimiento.seq);
		}
		...
		public bool UpdateChanges(movimiento movimiento, out string error,Sinapsys.Datos.SQL datosTransaccion=null)
		{
			...
			error = "";
			return LiqViajes_Bll_Data.DataProvider.UpdateFieldsbyObject(Fields, movimiento, out error,datosTransaccion);
		}
	}
