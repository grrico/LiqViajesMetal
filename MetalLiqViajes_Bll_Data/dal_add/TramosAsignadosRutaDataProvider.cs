	...
	public partial class TramosAsignadosRutaDataProvider
	{
		...
		public DataTable GetBy_lngIdRegistro(int lngIdRegistro)
        {
			try 
			{
                ...
                return LocalDataProvider.EjecutarProcedimiento("dbo.Add_LiquidacionRutasGetBy_lngIdRegistro", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
