...
{
	/// <summary>
	/// Data Access Layer class for LiquidacionPlanillaDet object
	/// </summary>
	/// <remarks>
	/// This class is a Singleton
	/// </remarks>
	public partial class LiquidacionPlanillaDetDataProvider
	{
		/// <summary>
		/// Internal member for create this singleton
		/// </summary>
		private static LiquidacionPlanillaDetDataProvider MySingleObj = null;

		/// <summary>
		/// Protected constructor to avoid access this singleton other way than calling the Instance method
		/// </summary>
		public LiquidacionPlanillaDetDataProvider()
		{
		...
		/// </summary>
		public static LiquidacionPlanillaDetDataProvider Instance
		{
			get
			{
				if (MySingleObj == null)
				{
					MySingleObj = new LiquidacionPlanillaDetDataProvider();
				}
		...
		/// <summary>
		/// Creates a new record into tblLiquidacionPlanillaDet by passing all fields
		/// </summary>
		...
		public int Create(int lngIdItemd, int? lngIdRegistro, int? lngIdRegistrRuta, int? lngIdRegistrRutaItemId, string strNoPlanilla, DateTime? dtmFechaModif,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				paramlist.AddWithValue("@lngIdItemd",lngIdItemd);
		...
		public void Update(int lngIdItemd, int? lngIdRegistro, int? lngIdRegistrRuta, int? lngIdRegistrRutaItemId, string strNoPlanilla, DateTime? dtmFechaModif,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				LocalDataProvider.EjecutarProcedimiento("dbo.LiquidacionPlanillaDetUpdate", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		public void Delete(int lngIdItemd,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				System.Collections.Hashtable nullExit = null;
				paramlist.AddWithValue("@lngIdItemd",lngIdItemd);
				LocalDataProvider.EjecutarProcedimiento("dbo.LiquidacionPlanillaDetDelete", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets one record from tblLiquidacionPlanillaDet passing all key fields
		/// </summary>
		/// <param name="lngIdItemd"></param>
		...
		public DataTable Get(int lngIdItemd)
		{
			try 
			{
				...
				System.Collections.Hashtable nullExit = null;
				paramlist.AddWithValue("@lngIdItemd",lngIdItemd);
				return LocalDataProvider.EjecutarProcedimiento("dbo.LiquidacionPlanillaDetGet", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
		...
		/// <summary>
		/// Gets all records from tblLiquidacionPlanillaDet
		/// </summary>
		...
		public DataTable GetAll()
		{
			try 
			{
				...
				System.Data.SqlClient.SqlParameterCollection paramlist = Comando.Parameters;
				System.Collections.Hashtable nullExit = null;
				return LocalDataProvider.EjecutarProcedimiento("dbo.LiquidacionPlanillaDetGetAll", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets all records from tblLiquidacionPlanillaDet applying filter and sort criteria
		/// </summary>
		...
		public DataTable GetFilter(int pagenum, int pagesize, string filter, string sort, string extablesfilter, string extablesfieldsfilter, string extablesrelationsfilter, string extablessort, string extablesfieldssort, string extablesrelationssort)
		{
			try 
			{
				...
				return LocalDataProvider.EjecutarProcedimiento("dbo.LiquidacionPlanillaDetGetFilter", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets the numbers of records from tblLiquidacionPlanillaDet applying filter and sort criteria
		/// </summary>
		/// <param name="pagenum">Contents the page number (z-ordered) of records to return.</param>
		/// <param name="pagesize">Contents the number of records per page (0 for returns all records).</param>
		/// <param name="filter">Contents the criteria (as SQL sentence) for filter records (ex. Qty > 0).</param>
		...
		public int GetFilterCount(int pagenum, int pagesize, string filter, string sort, string extablesfilter, string extablesfieldsfilter, string extablesrelationsfilter, string extablessort, string extablesfieldssort, string extablesrelationssort)
		{
			try 
			{
				...
				return (int) LocalDataProvider.EjecutarProcedimiento("dbo.LiquidacionPlanillaDetGetFilter", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera).Rows[0][0];
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
