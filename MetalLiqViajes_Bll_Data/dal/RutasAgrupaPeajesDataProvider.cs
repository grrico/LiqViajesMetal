...
{
	/// <summary>
	/// Data Access Layer class for RutasAgrupaPeajes object
	/// </summary>
	/// <remarks>
	/// This class is a Singleton
	/// </remarks>
	public partial class RutasAgrupaPeajesDataProvider
	{
		/// <summary>
		/// Internal member for create this singleton
		/// </summary>
		private static RutasAgrupaPeajesDataProvider MySingleObj = null;

		/// <summary>
		/// Protected constructor to avoid access this singleton other way than calling the Instance method
		/// </summary>
		public RutasAgrupaPeajesDataProvider()
		{
		...
		/// </summary>
		public static RutasAgrupaPeajesDataProvider Instance
		{
			get
			{
				if (MySingleObj == null)
				{
					MySingleObj = new RutasAgrupaPeajesDataProvider();
				}
		...
		/// <summary>
		/// Creates a new record into tblRutasAgrupaPeajes by passing all fields
		/// </summary>
		/// <param name="strNombreGrupo"></param>
		/// <returns>int that contents the lngIdGrupo value</returns>
		public int Create(int lngIdGrupo, string strNombreGrupo,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				if (strNombreGrupo !=null)
				{
					paramlist.AddWithValue("@strNombreGrupo",strNombreGrupo);
				}
				// Execute the query and return the new identity value
				int returnValue = Convert.ToInt32(LocalDataProvider.EjecutarProcedimiento("dbo.RutasAgrupaPeajesCreate", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera).Rows[0][0]);
		...
		public void Update(int lngIdGrupo, string strNombreGrupo,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				LocalDataProvider.EjecutarProcedimiento("dbo.RutasAgrupaPeajesUpdate", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Deletes one record from tblRutasAgrupaPeajes by passing all key fields
		/// </summary>
		/// <param name="lngIdGrupo"></param>
		public void Delete(int lngIdGrupo,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				Sinapsys.Datos.SQL LocalDataProvider;
				...
				System.Collections.Hashtable nullExit = null;
				paramlist.AddWithValue("@lngIdGrupo",lngIdGrupo);
				LocalDataProvider.EjecutarProcedimiento("dbo.RutasAgrupaPeajesDelete", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets one record from tblRutasAgrupaPeajes passing all key fields
		/// </summary>
		/// <param name="lngIdGrupo"></param>
		/// <returns>A DataTable object containing the data</returns>
		public DataTable Get(int lngIdGrupo)
		{
			try 
			{
				Sinapsys.Datos.SQL LocalDataProvider;
				...
				System.Collections.Hashtable nullExit = null;
				paramlist.AddWithValue("@lngIdGrupo",lngIdGrupo);
				return LocalDataProvider.EjecutarProcedimiento("dbo.RutasAgrupaPeajesGet", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
		...
		/// <summary>
		/// Gets all records from tblRutasAgrupaPeajes
		/// </summary>
		...
		public DataTable GetAll()
		{
			try 
			{
				...
				System.Data.SqlClient.SqlParameterCollection paramlist = Comando.Parameters;
				System.Collections.Hashtable nullExit = null;
				return LocalDataProvider.EjecutarProcedimiento("dbo.RutasAgrupaPeajesGetAll", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets all records from tblRutasAgrupaPeajes applying filter and sort criteria
		/// </summary>
		...
		public DataTable GetFilter(int pagenum, int pagesize, string filter, string sort, string extablesfilter, string extablesfieldsfilter, string extablesrelationsfilter, string extablessort, string extablesfieldssort, string extablesrelationssort)
		{
			try 
			{
				...
				return LocalDataProvider.EjecutarProcedimiento("dbo.RutasAgrupaPeajesGetFilter", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets the numbers of records from tblRutasAgrupaPeajes applying filter and sort criteria
		/// </summary>
		/// <param name="pagenum">Contents the page number (z-ordered) of records to return.</param>
		/// <param name="pagesize">Contents the number of records per page (0 for returns all records).</param>
		/// <param name="filter">Contents the criteria (as SQL sentence) for filter records (ex. Qty > 0).</param>
		...
		public int GetFilterCount(int pagenum, int pagesize, string filter, string sort, string extablesfilter, string extablesfieldsfilter, string extablesrelationsfilter, string extablessort, string extablesfieldssort, string extablesrelationssort)
		{
			try 
			{
				...
				return (int) LocalDataProvider.EjecutarProcedimiento("dbo.RutasAgrupaPeajesGetFilter", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera).Rows[0][0];
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
