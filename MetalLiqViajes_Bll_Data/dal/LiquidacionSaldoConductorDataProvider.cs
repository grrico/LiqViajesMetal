...
{
	/// <summary>
	/// Data Access Layer class for LiquidacionSaldoConductor object
	/// </summary>
	/// <remarks>
	/// This class is a Singleton
	/// </remarks>
	public partial class LiquidacionSaldoConductorDataProvider
	{
		/// <summary>
		/// Internal member for create this singleton
		/// </summary>
		private static LiquidacionSaldoConductorDataProvider MySingleObj = null;

		/// <summary>
		/// Protected constructor to avoid access this singleton other way than calling the Instance method
		/// </summary>
		public LiquidacionSaldoConductorDataProvider()
		{
		...
		/// </summary>
		public static LiquidacionSaldoConductorDataProvider Instance
		{
			get
			{
				if (MySingleObj == null)
				{
					MySingleObj = new LiquidacionSaldoConductorDataProvider();
				}
		...
		/// <summary>
		/// Creates a new record into tblLiquidacionSaldoConductor by passing all fields
		/// </summary>
		...
		public void Create(long lngIdRegistro, decimal intNitConductor, decimal? curValorSaldo, DateTime? dtmFechaModif, byte? sw, string strTipo, int? numero, int? lngIdRegistroLiq,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				if (curValorSaldo !=null)
				{
					paramlist.AddWithValue("@curValorSaldo",curValorSaldo);
				}
				...
				if (lngIdRegistroLiq !=null)
				{
					paramlist.AddWithValue("@lngIdRegistroLiq",lngIdRegistroLiq);
				}
				LocalDataProvider.EjecutarProcedimiento("dbo.LiquidacionSaldoConductorCreate", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
		...
		public void Update(long lngIdRegistro, decimal intNitConductor, decimal? curValorSaldo, DateTime? dtmFechaModif, byte? sw, string strTipo, int? numero, int? lngIdRegistroLiq,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				LocalDataProvider.EjecutarProcedimiento("dbo.LiquidacionSaldoConductorUpdate", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Deletes one record from tblLiquidacionSaldoConductor by passing all key fields
		/// </summary>
		/// <param name="lngIdRegistro"></param>
		/// <param name="intNitConductor"></param>
		public void Delete(long lngIdRegistro, decimal intNitConductor,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				paramlist.AddWithValue("@lngIdRegistro",lngIdRegistro);
				paramlist.AddWithValue("@intNitConductor",intNitConductor);
				LocalDataProvider.EjecutarProcedimiento("dbo.LiquidacionSaldoConductorDelete", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets one record from tblLiquidacionSaldoConductor passing all key fields
		/// </summary>
		/// <param name="lngIdRegistro"></param>
		/// <param name="intNitConductor"></param>
		...
		public DataTable Get(long lngIdRegistro, decimal intNitConductor)
		{
			try 
			{
				...
				paramlist.AddWithValue("@lngIdRegistro",lngIdRegistro);
				paramlist.AddWithValue("@intNitConductor",intNitConductor);
				return LocalDataProvider.EjecutarProcedimiento("dbo.LiquidacionSaldoConductorGet", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
		...
		/// <summary>
		/// Gets all records from tblLiquidacionSaldoConductor
		/// </summary>
		...
		public DataTable GetAll()
		{
			try 
			{
				...
				System.Data.SqlClient.SqlParameterCollection paramlist = Comando.Parameters;
				System.Collections.Hashtable nullExit = null;
				return LocalDataProvider.EjecutarProcedimiento("dbo.LiquidacionSaldoConductorGetAll", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets all records from tblLiquidacionSaldoConductor applying filter and sort criteria
		/// </summary>
		...
		public DataTable GetFilter(int pagenum, int pagesize, string filter, string sort, string extablesfilter, string extablesfieldsfilter, string extablesrelationsfilter, string extablessort, string extablesfieldssort, string extablesrelationssort)
		{
			try 
			{
				...
				return LocalDataProvider.EjecutarProcedimiento("dbo.LiquidacionSaldoConductorGetFilter", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets the numbers of records from tblLiquidacionSaldoConductor applying filter and sort criteria
		/// </summary>
		/// <param name="pagenum">Contents the page number (z-ordered) of records to return.</param>
		/// <param name="pagesize">Contents the number of records per page (0 for returns all records).</param>
		/// <param name="filter">Contents the criteria (as SQL sentence) for filter records (ex. Qty > 0).</param>
		...
		public int GetFilterCount(int pagenum, int pagesize, string filter, string sort, string extablesfilter, string extablesfieldsfilter, string extablesrelationsfilter, string extablessort, string extablesfieldssort, string extablesrelationssort)
		{
			try 
			{
				...
				return (int) LocalDataProvider.EjecutarProcedimiento("dbo.LiquidacionSaldoConductorGetFilter", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera).Rows[0][0];
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
