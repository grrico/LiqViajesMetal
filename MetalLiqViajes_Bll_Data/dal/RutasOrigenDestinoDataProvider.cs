...
namespace LiqViajes_Bll_Data
{
	...
	public partial class RutasOrigenDestinoDataProvider
	{
		...
		public void Create(int Codigo, string Origen, string Destino, string GrupoOrigen, string GrupoDestino, int? TipoTrailerCodigo, string DescripcionTrailer,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				LocalDataProvider.EjecutarProcedimiento("dbo.RutasOrigenDestinoCreate", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
		...
		/// <param name="TipoTrailerCodigo"></param>
		/// <param name="DescripcionTrailer"></param>
		public void Update(int Codigo, string Origen, string Destino, string GrupoOrigen, string GrupoDestino, int? TipoTrailerCodigo, string DescripcionTrailer,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				Sinapsys.Datos.SQL LocalDataProvider;
