...
{
	/// <summary>
	/// Data Access Layer class for Catalogo object
	/// </summary>
	/// <remarks>
	/// This class is a Singleton
	/// </remarks>
	public partial class CatalogoDataProvider
	{
		/// <summary>
		/// Internal member for create this singleton
		/// </summary>
		private static CatalogoDataProvider MySingleObj = null;

		/// <summary>
		/// Protected constructor to avoid access this singleton other way than calling the Instance method
		/// </summary>
		public CatalogoDataProvider()
		{
		...
		/// </summary>
		public static CatalogoDataProvider Instance
		{
			get
			{
				if (MySingleObj == null)
				{
					MySingleObj = new CatalogoDataProvider();
				}
		...
		/// <summary>
		/// Creates a new record into tblCatalogo by passing all fields
		/// </summary>
		...
		public void Create(string nombre_empresa, DateTime fecha_actual, string sigla, int nit, int version, string direccion, string telefono,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				paramlist.AddWithValue("@nombre_empresa",nombre_empresa);
				paramlist.AddWithValue("@fecha_actual",fecha_actual);
				paramlist.AddWithValue("@sigla",sigla);
				paramlist.AddWithValue("@nit",nit);
				paramlist.AddWithValue("@version",version);
				paramlist.AddWithValue("@direccion",direccion);
				paramlist.AddWithValue("@telefono",telefono);
				LocalDataProvider.EjecutarProcedimiento("dbo.CatalogoCreate", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
		...
		public void Update(DateTime fecha_actual, string sigla, int nit, int version, string direccion, string telefono, string nombre_empresa,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				paramlist.AddWithValue("@direccion",direccion);
				paramlist.AddWithValue("@telefono",telefono);
				LocalDataProvider.EjecutarProcedimiento("dbo.CatalogoUpdate", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Deletes one record from tblCatalogo by passing all key fields
		/// </summary>
		/// <param name="nombre_empresa"></param>
		public void Delete(string nombre_empresa,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				Sinapsys.Datos.SQL LocalDataProvider;
				...
				System.Collections.Hashtable nullExit = null;
				paramlist.AddWithValue("@nombre_empresa",nombre_empresa);
				LocalDataProvider.EjecutarProcedimiento("dbo.CatalogoDelete", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets one record from tblCatalogo passing all key fields
		/// </summary>
		/// <param name="nombre_empresa"></param>
		/// <returns>A DataTable object containing the data</returns>
		public DataTable Get(string nombre_empresa)
		{
			try 
			{
				Sinapsys.Datos.SQL LocalDataProvider;
				...
				System.Collections.Hashtable nullExit = null;
				paramlist.AddWithValue("@nombre_empresa",nombre_empresa);
				return LocalDataProvider.EjecutarProcedimiento("dbo.CatalogoGet", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
		...
		/// <summary>
		/// Gets all records from tblCatalogo
		/// </summary>
		...
		public DataTable GetAll()
		{
			try 
			{
				...
				System.Data.SqlClient.SqlParameterCollection paramlist = Comando.Parameters;
				System.Collections.Hashtable nullExit = null;
				return LocalDataProvider.EjecutarProcedimiento("dbo.CatalogoGetAll", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets all records from tblCatalogo applying filter and sort criteria
		/// </summary>
		...
		public DataTable GetFilter(int pagenum, int pagesize, string filter, string sort, string extablesfilter, string extablesfieldsfilter, string extablesrelationsfilter, string extablessort, string extablesfieldssort, string extablesrelationssort)
		{
			try 
			{
				...
				return LocalDataProvider.EjecutarProcedimiento("dbo.CatalogoGetFilter", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets the numbers of records from tblCatalogo applying filter and sort criteria
		/// </summary>
		/// <param name="pagenum">Contents the page number (z-ordered) of records to return.</param>
		/// <param name="pagesize">Contents the number of records per page (0 for returns all records).</param>
		/// <param name="filter">Contents the criteria (as SQL sentence) for filter records (ex. Qty > 0).</param>
		...
		public int GetFilterCount(int pagenum, int pagesize, string filter, string sort, string extablesfilter, string extablesfieldsfilter, string extablesrelationsfilter, string extablessort, string extablesfieldssort, string extablesrelationssort)
		{
			try 
			{
				...
				return (int) LocalDataProvider.EjecutarProcedimiento("dbo.CatalogoGetFilter", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera).Rows[0][0];
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
