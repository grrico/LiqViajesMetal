...
{
	/// <summary>
	/// Data Access Layer class for RutasDet object
	/// </summary>
	/// <remarks>
	/// This class is a Singleton
	/// </remarks>
	public partial class RutasDetDataProvider
	{
		/// <summary>
		/// Internal member for create this singleton
		/// </summary>
		private static RutasDetDataProvider MySingleObj = null;

		/// <summary>
		/// Protected constructor to avoid access this singleton other way than calling the Instance method
		/// </summary>
		public RutasDetDataProvider()
		{
		...
		/// </summary>
		public static RutasDetDataProvider Instance
		{
			get
			{
				if (MySingleObj == null)
				{
					MySingleObj = new RutasDetDataProvider();
				}
		...
		/// <summary>
		/// Creates a new record into tblRutasDet by passing all fields
		/// </summary>
		...
		public long Create(long lngIdItemdReg, long lngIdRegistrRuta, long lngIdPeaje, string strNombrePeaje, decimal? curValorPeaje,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				paramlist.AddWithValue("@lngIdItemdReg",lngIdItemdReg);
		...
		public void Update(long lngIdItemdReg, long lngIdRegistrRuta, long lngIdPeaje, string strNombrePeaje, decimal? curValorPeaje,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				LocalDataProvider.EjecutarProcedimiento("dbo.RutasDetUpdate", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Deletes one record from tblRutasDet by passing all key fields
		/// </summary>
		/// <param name="lngIdItemdReg"></param>
		/// <param name="lngIdRegistrRuta"></param>
		/// <param name="lngIdPeaje"></param>
		public void Delete(long lngIdItemdReg, long lngIdRegistrRuta, long lngIdPeaje,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				paramlist.AddWithValue("@lngIdRegistrRuta",lngIdRegistrRuta);
				paramlist.AddWithValue("@lngIdPeaje",lngIdPeaje);
				LocalDataProvider.EjecutarProcedimiento("dbo.RutasDetDelete", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets one record from tblRutasDet passing all key fields
		/// </summary>
		/// <param name="lngIdItemdReg"></param>
		/// <param name="lngIdRegistrRuta"></param>
		/// <param name="lngIdPeaje"></param>
		...
		public DataTable Get(long lngIdItemdReg, long lngIdRegistrRuta, long lngIdPeaje)
		{
			try 
			{
				...
				paramlist.AddWithValue("@lngIdRegistrRuta",lngIdRegistrRuta);
				paramlist.AddWithValue("@lngIdPeaje",lngIdPeaje);
				return LocalDataProvider.EjecutarProcedimiento("dbo.RutasDetGet", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
		...
		/// <summary>
		/// Gets all records from tblRutasDet
		/// </summary>
		...
		public DataTable GetAll()
		{
			try 
			{
				...
				System.Data.SqlClient.SqlParameterCollection paramlist = Comando.Parameters;
				System.Collections.Hashtable nullExit = null;
				return LocalDataProvider.EjecutarProcedimiento("dbo.RutasDetGetAll", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets all records from tblRutasDet applying filter and sort criteria
		/// </summary>
		...
		public DataTable GetFilter(int pagenum, int pagesize, string filter, string sort, string extablesfilter, string extablesfieldsfilter, string extablesrelationsfilter, string extablessort, string extablesfieldssort, string extablesrelationssort)
		{
			try 
			{
				...
				return LocalDataProvider.EjecutarProcedimiento("dbo.RutasDetGetFilter", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets the numbers of records from tblRutasDet applying filter and sort criteria
		/// </summary>
		/// <param name="pagenum">Contents the page number (z-ordered) of records to return.</param>
		/// <param name="pagesize">Contents the number of records per page (0 for returns all records).</param>
		/// <param name="filter">Contents the criteria (as SQL sentence) for filter records (ex. Qty > 0).</param>
		...
		public int GetFilterCount(int pagenum, int pagesize, string filter, string sort, string extablesfilter, string extablesfieldsfilter, string extablesrelationsfilter, string extablessort, string extablesfieldssort, string extablesrelationssort)
		{
			try 
			{
				...
				return (int) LocalDataProvider.EjecutarProcedimiento("dbo.RutasDetGetFilter", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera).Rows[0][0];
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
