...
{
	/// <summary>
	/// Data Access Layer class for RutaSatrackLastEvents object
	/// </summary>
	/// <remarks>
	/// This class is a Singleton
	/// </remarks>
	public partial class RutaSatrackLastEventsDataProvider
	{
		/// <summary>
		/// Internal member for create this singleton
		/// </summary>
		private static RutaSatrackLastEventsDataProvider MySingleObj = null;

		/// <summary>
		/// Protected constructor to avoid access this singleton other way than calling the Instance method
		/// </summary>
		public RutaSatrackLastEventsDataProvider()
		{
		...
		/// </summary>
		public static RutaSatrackLastEventsDataProvider Instance
		{
			get
			{
				if (MySingleObj == null)
				{
					MySingleObj = new RutaSatrackLastEventsDataProvider();
				}
		...
		/// <summary>
		/// Creates a new record into RutaSatrackLastEvents by passing all fields
		/// </summary>
		...
		public void Create(string Placa, DateTime? FechaSistema, DateTime? FechaHora_GPS, string EventoPrioridad, string VelocidadSentido, string Edad_Posicion, string Ubicacion, decimal? Latitud, decimal? Longitud,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				LocalDataProvider.EjecutarProcedimiento("dbo.RutaSatrackLastEventsCreate", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
		...
		/// <summary>
		/// Updates one record into RutaSatrackLastEvents by passing all fields
		/// </summary>
		...
		/// <param name="Latitud"></param>
		/// <param name="Longitud"></param>
		public void Update(string Placa, DateTime? FechaSistema, DateTime? FechaHora_GPS, string EventoPrioridad, string VelocidadSentido, string Edad_Posicion, string Ubicacion, decimal? Latitud, decimal? Longitud,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				Sinapsys.Datos.SQL LocalDataProvider;
				...
				LocalDataProvider.EjecutarProcedimiento("dbo.RutaSatrackLastEventsUpdate", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Deletes one record from RutaSatrackLastEvents by passing all key fields
		/// </summary>
		/// <param name="Placa"></param>
		public void Delete(string Placa,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				Sinapsys.Datos.SQL LocalDataProvider;
				...
				System.Collections.Hashtable nullExit = null;
				paramlist.AddWithValue("@Placa",Placa);
				LocalDataProvider.EjecutarProcedimiento("dbo.RutaSatrackLastEventsDelete", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets one record from RutaSatrackLastEvents passing all key fields
		/// </summary>
		/// <param name="Placa"></param>
		/// <returns>A DataTable object containing the data</returns>
		public DataTable Get(string Placa)
		{
			try 
			{
				Sinapsys.Datos.SQL LocalDataProvider;
				...
				System.Collections.Hashtable nullExit = null;
				paramlist.AddWithValue("@Placa",Placa);
				return LocalDataProvider.EjecutarProcedimiento("dbo.RutaSatrackLastEventsGet", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
		...
		/// <summary>
		/// Gets all records from RutaSatrackLastEvents
		/// </summary>
		...
		public DataTable GetAll()
		{
			try 
			{
				...
				System.Data.SqlClient.SqlParameterCollection paramlist = Comando.Parameters;
				System.Collections.Hashtable nullExit = null;
				return LocalDataProvider.EjecutarProcedimiento("dbo.RutaSatrackLastEventsGetAll", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets all records from RutaSatrackLastEvents applying filter and sort criteria
		/// </summary>
		...
		public DataTable GetFilter(int pagenum, int pagesize, string filter, string sort, string extablesfilter, string extablesfieldsfilter, string extablesrelationsfilter, string extablessort, string extablesfieldssort, string extablesrelationssort)
		{
			try 
			{
				...
				return LocalDataProvider.EjecutarProcedimiento("dbo.RutaSatrackLastEventsGetFilter", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets the numbers of records from RutaSatrackLastEvents applying filter and sort criteria
		/// </summary>
		/// <param name="pagenum">Contents the page number (z-ordered) of records to return.</param>
		/// <param name="pagesize">Contents the number of records per page (0 for returns all records).</param>
		/// <param name="filter">Contents the criteria (as SQL sentence) for filter records (ex. Qty > 0).</param>
		...
		public int GetFilterCount(int pagenum, int pagesize, string filter, string sort, string extablesfilter, string extablesfieldsfilter, string extablesrelationsfilter, string extablessort, string extablesfieldssort, string extablesrelationssort)
		{
			try 
			{
				...
				return (int) LocalDataProvider.EjecutarProcedimiento("dbo.RutaSatrackLastEventsGetFilter", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera).Rows[0][0];
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
