...
namespace LiqViajes_Bll_Data
{
	...
	public partial class CuentasDataProvider
	{
		...
		/// <summary>
		/// Creates a new record into tblCuentas by passing all fields
		/// </summary>
		/// <param name="strCuenta"></param>
		/// <param name="strDescripcion"></param>
		/// <param name="logAnticipo"></param>
		/// <param name="nitTercero"></param>
		/// <param name="intNoColReferencia"></param>
		/// <param name="sngPorcenrajeAplica"></param>
		...
		public int Create(int Codigo, string strCuenta, string strDescripcion, bool? logAnticipo, string nitTercero, int? intNoColReferencia, double? sngPorcenrajeAplica, string strCuentaAplica, string strCuentaNiif, string Norma,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				if (intNoColReferencia !=null)
				{
					paramlist.AddWithValue("@intNoColReferencia",intNoColReferencia);
				}
				if (sngPorcenrajeAplica !=null)
				{
					paramlist.AddWithValue("@sngPorcenrajeAplica",sngPorcenrajeAplica);
				}
				if (strCuentaAplica !=null)
				{
					paramlist.AddWithValue("@strCuentaAplica",strCuentaAplica);
				}
				if (strCuentaNiif !=null)
				{
					paramlist.AddWithValue("@strCuentaNiif",strCuentaNiif);
				}
				if (Norma !=null)
				{
		...
		/// <summary>
		/// Deletes one record from tblCuentas by passing all key fields
		/// </summary>
		/// <param name="Codigo"></param>
		...
		/// <summary>
		/// Gets one record from tblCuentas passing all key fields
		/// </summary>
		/// <param name="Codigo"></param>
		...
		/// <summary>
		/// Gets all records from tblCuentas
		/// </summary>
		...
		/// <summary>
		/// Gets all records from tblCuentas applying filter and sort criteria
		/// </summary>
		...
		/// <summary>
		/// Gets the numbers of records from tblCuentas applying filter and sort criteria
		/// </summary>
		/// <param name="pagenum">Contents the page number (z-ordered) of records to return.</param>
		/// <param name="pagesize">Contents the number of records per page (0 for returns all records).</param>
		/// <param name="filter">Contents the criteria (as SQL sentence) for filter records (ex. Qty > 0).</param>
