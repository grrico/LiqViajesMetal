...
{
	/// <summary>
	/// Data Access Layer class for Documento_Referencia object
	/// </summary>
	/// <remarks>
	/// This class is a Singleton
	/// </remarks>
	public partial class Documento_ReferenciaDataProvider
	{
		/// <summary>
		/// Internal member for create this singleton
		/// </summary>
		private static Documento_ReferenciaDataProvider MySingleObj = null;

		/// <summary>
		/// Protected constructor to avoid access this singleton other way than calling the Instance method
		/// </summary>
		public Documento_ReferenciaDataProvider()
		{
		...
		/// </summary>
		public static Documento_ReferenciaDataProvider Instance
		{
			get
			{
				if (MySingleObj == null)
				{
					MySingleObj = new Documento_ReferenciaDataProvider();
				}
		...
		/// <summary>
		/// Creates a new record into tblDocumento_Referencia by passing all fields
		/// </summary>
		/// <param name="lngIdRegistro"></param>
		/// <param name="fecha"></param>
		/// <param name="valor"></param>
		/// <param name="ValorCruce"></param>
		public void Create(byte sw, string tipo, int numero, int? lngIdRegistro, DateTime fecha, decimal valor, decimal? ValorCruce,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				if (ValorCruce !=null)
				{
					paramlist.AddWithValue("@ValorCruce",ValorCruce);
				}
				LocalDataProvider.EjecutarProcedimiento("dbo.Documento_ReferenciaCreate", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
		...
		public void Update(int? lngIdRegistro, DateTime fecha, decimal valor, decimal? ValorCruce, byte sw, string tipo, int numero,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				LocalDataProvider.EjecutarProcedimiento("dbo.Documento_ReferenciaUpdate", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Deletes one record from tblDocumento_Referencia by passing all key fields
		/// </summary>
		/// <param name="sw"></param>
		/// <param name="tipo"></param>
		/// <param name="numero"></param>
		public void Delete(byte sw, string tipo, int numero,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				Sinapsys.Datos.SQL LocalDataProvider;
				...
				paramlist.AddWithValue("@tipo",tipo);
				paramlist.AddWithValue("@numero",numero);
				LocalDataProvider.EjecutarProcedimiento("dbo.Documento_ReferenciaDelete", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets one record from tblDocumento_Referencia passing all key fields
		/// </summary>
		/// <param name="sw"></param>
		/// <param name="tipo"></param>
		/// <param name="numero"></param>
		/// <returns>A DataTable object containing the data</returns>
		public DataTable Get(byte sw, string tipo, int numero)
		{
			try 
			{
				Sinapsys.Datos.SQL LocalDataProvider;
				...
				paramlist.AddWithValue("@tipo",tipo);
				paramlist.AddWithValue("@numero",numero);
				return LocalDataProvider.EjecutarProcedimiento("dbo.Documento_ReferenciaGet", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
		...
		/// <summary>
		/// Gets all records from tblDocumento_Referencia
		/// </summary>
		...
		public DataTable GetAll()
		{
			try 
			{
				...
				System.Data.SqlClient.SqlParameterCollection paramlist = Comando.Parameters;
				System.Collections.Hashtable nullExit = null;
				return LocalDataProvider.EjecutarProcedimiento("dbo.Documento_ReferenciaGetAll", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets all records from tblDocumento_Referencia applying filter and sort criteria
		/// </summary>
		...
		public DataTable GetFilter(int pagenum, int pagesize, string filter, string sort, string extablesfilter, string extablesfieldsfilter, string extablesrelationsfilter, string extablessort, string extablesfieldssort, string extablesrelationssort)
		{
			try 
			{
				...
				return LocalDataProvider.EjecutarProcedimiento("dbo.Documento_ReferenciaGetFilter", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets the numbers of records from tblDocumento_Referencia applying filter and sort criteria
		/// </summary>
		/// <param name="pagenum">Contents the page number (z-ordered) of records to return.</param>
		/// <param name="pagesize">Contents the number of records per page (0 for returns all records).</param>
		/// <param name="filter">Contents the criteria (as SQL sentence) for filter records (ex. Qty > 0).</param>
		...
		public int GetFilterCount(int pagenum, int pagesize, string filter, string sort, string extablesfilter, string extablesfieldsfilter, string extablesrelationsfilter, string extablessort, string extablesfieldssort, string extablesrelationssort)
		{
			try 
			{
				...
				return (int) LocalDataProvider.EjecutarProcedimiento("dbo.Documento_ReferenciaGetFilter", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera).Rows[0][0];
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
