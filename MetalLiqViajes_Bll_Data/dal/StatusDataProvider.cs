...
{
	/// <summary>
	/// Data Access Layer class for Status object
	/// </summary>
	/// <remarks>
	/// This class is a Singleton
	/// </remarks>
	public partial class StatusDataProvider
	{
		/// <summary>
		/// Internal member for create this singleton
		/// </summary>
		private static StatusDataProvider MySingleObj = null;
		...
		/// </summary>
		public static StatusDataProvider Instance
		{
			get
			{
				if (MySingleObj == null)
				{
					MySingleObj = new StatusDataProvider();
				}
		...
		/// <summary>
		/// Creates a new record into tblStatus by passing all fields
		/// </summary>
		/// <param name="strStatus"></param>
		/// <returns>int that contents the lngIdStatus value</returns>
		public int Create(int lngIdStatus, string strStatus,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				if (strStatus !=null)
				{
					paramlist.AddWithValue("@strStatus",strStatus);
				}
				// Execute the query and return the new identity value
				int returnValue = Convert.ToInt32(LocalDataProvider.EjecutarProcedimiento("dbo.StatusCreate", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera).Rows[0][0]);
		...
		public void Update(int lngIdStatus, string strStatus,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				...
				LocalDataProvider.EjecutarProcedimiento("dbo.StatusUpdate", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Deletes one record from tblStatus by passing all key fields
		/// </summary>
		/// <param name="lngIdStatus"></param>
		public void Delete(int lngIdStatus,string module, Sinapsys.Datos.SQL datosTransaccion=null)
		{
			try 
			{
				Sinapsys.Datos.SQL LocalDataProvider;
				...
				System.Collections.Hashtable nullExit = null;
				paramlist.AddWithValue("@lngIdStatus",lngIdStatus);
				LocalDataProvider.EjecutarProcedimiento("dbo.StatusDelete", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets one record from tblStatus passing all key fields
		/// </summary>
		/// <param name="lngIdStatus"></param>
		/// <returns>A DataTable object containing the data</returns>
		public DataTable Get(int lngIdStatus)
		{
			try 
			{
				Sinapsys.Datos.SQL LocalDataProvider;
				...
				System.Collections.Hashtable nullExit = null;
				paramlist.AddWithValue("@lngIdStatus",lngIdStatus);
				return LocalDataProvider.EjecutarProcedimiento("dbo.StatusGet", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
		...
		/// <summary>
		/// Gets all records from tblStatus
		/// </summary>
		...
		public DataTable GetAll()
		{
			try 
			{
				...
				System.Data.SqlClient.SqlParameterCollection paramlist = Comando.Parameters;
				System.Collections.Hashtable nullExit = null;
				return LocalDataProvider.EjecutarProcedimiento("dbo.StatusGetAll", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets all records from tblStatus applying filter and sort criteria
		/// </summary>
		...
		public DataTable GetFilter(int pagenum, int pagesize, string filter, string sort, string extablesfilter, string extablesfieldsfilter, string extablesrelationsfilter, string extablessort, string extablesfieldssort, string extablesrelationssort)
		{
			try 
			{
				...
				return LocalDataProvider.EjecutarProcedimiento("dbo.StatusGetFilter", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera);
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
		...
		/// <summary>
		/// Gets the numbers of records from tblStatus applying filter and sort criteria
		/// </summary>
		/// <param name="pagenum">Contents the page number (z-ordered) of records to return.</param>
		/// <param name="pagesize">Contents the number of records per page (0 for returns all records).</param>
		/// <param name="filter">Contents the criteria (as SQL sentence) for filter records (ex. Qty > 0).</param>
		...
		public int GetFilterCount(int pagenum, int pagesize, string filter, string sort, string extablesfilter, string extablesfieldsfilter, string extablesrelationsfilter, string extablessort, string extablesfieldssort, string extablesrelationssort)
		{
			try 
			{
				...
				return (int) LocalDataProvider.EjecutarProcedimiento("dbo.StatusGetFilter", paramlist, disconnect, out nullExit, DataProvider.TiempoEspera).Rows[0][0];
			}
			catch (Exception ex)
			{
				Utilidades.LogErrores(ex.Message + (ex.InnerException != null ? ex.InnerException.Message : ""), DataProvider.AplicacionNombre);
