    ...
    public partial class fReportesViajes : Form
    {
            ...
            try
            {
                ...
                foreach (DataTable dt in result.Tables)
                {
                    if (dt.TableName.ToUpper() == comboBoxHojas.Text.ToUpper())
                    {
                        ...
                        // Resize the master DataGridView columns to fit the newly loaded data.
                        dataGridViewRutas.AutoResizeColumns();

                        // Configure the details DataGridView so that its columns automatically
                        // adjust their widths when the data changes.
                        dataGridViewRutas.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells;
        ...
        private Rutas ReadData(DataTable dt, int i)
        {
            ...
            try
            {
                ...
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column30")] != null) rutas.cutVariosPropinaVacio = Convert.ToDecimal(dt.Rows[i].ItemArray[29]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column31")] != null) rutas.cutVariosVacio = Convert.ToDecimal(dt.Rows[i].ItemArray[30]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column32")] != null) rutas.Viaticos = Convert.ToDecimal(dt.Rows[i].ItemArray[31]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column33")] != null) rutas.cutParticipacion = Convert.ToDecimal(dt.Rows[i].ItemArray[32]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column34")] != null) rutas.cutParticipacionVacio = Convert.ToDecimal(dt.Rows[i].ItemArray[33]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column35")] != null) rutas.curHotelCarretera = Convert.ToInt32(dt.Rows[i].ItemArray[34]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column36")] != null) rutas.curHotelCiudad = Convert.ToInt32(dt.Rows[i].ItemArray[35]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column37")] != null) rutas.curHotel = Convert.ToDecimal(dt.Rows[i].ItemArray[36]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column38")] != null) rutas.curHotelCarreteraVacio = Convert.ToInt32(dt.Rows[i].ItemArray[37]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column39")] != null) rutas.curHotelCiudadVacio = Convert.ToInt32(dt.Rows[i].ItemArray[38]);

                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column40")] != null) rutas.curHotelVacio = Convert.ToDecimal(dt.Rows[i].ItemArray[39]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column41")] != null) rutas.intTiempoCargue = Convert.ToDecimal(dt.Rows[i].ItemArray[40]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column42")] != null) rutas.intTiempoDescargue = Convert.ToDecimal(dt.Rows[i].ItemArray[41]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column43")] != null) rutas.intTiempoAduana = Convert.ToDecimal(dt.Rows[i].ItemArray[42]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column44")] != null) rutas.intTotalTrayecto = Convert.ToDecimal(dt.Rows[i].ItemArray[43]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column45")] != null) rutas.intTotalTiempo = Convert.ToDecimal(dt.Rows[i].ItemArray[44]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column46")] != null) rutas.curComida = Convert.ToDecimal(dt.Rows[i].ItemArray[45]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column47")] != null) rutas.intTiempoCargueVacio = Convert.ToDecimal(dt.Rows[i].ItemArray[46]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column48")] != null) rutas.intTiempoDescargueVacio = Convert.ToDecimal(dt.Rows[i].ItemArray[47]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column49")] != null) rutas.intTiempoAduanaVacio = Convert.ToDecimal(dt.Rows[i].ItemArray[48]);

                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column50")] != null) rutas.intTotalTrayectoVacio = Convert.ToDecimal(dt.Rows[i].ItemArray[49]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column51")] != null) rutas.intTotalTiempoVacio = Convert.ToDecimal(dt.Rows[i].ItemArray[50]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column52")] != null) rutas.curComidaVacio = Convert.ToDecimal(dt.Rows[i].ItemArray[51]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column53")] != null) rutas.curDesvareManoRepuestos = Convert.ToDecimal(dt.Rows[i].ItemArray[52]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column54")] != null) rutas.curDesvareManoObra = Convert.ToDecimal(dt.Rows[i].ItemArray[53]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column55")] != null) rutas.cutSaldo = Convert.ToDecimal(dt.Rows[i].ItemArray[54]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column56")] != null) rutas.cutSaldoVacio = Convert.ToDecimal(dt.Rows[i].ItemArray[55]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column57")] != null) rutas.cutKmts = Convert.ToDecimal(dt.Rows[i].ItemArray[56]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column58")] != null) rutas.logActualizaPeajes = Convert.ToDecimal(dt.Rows[i].ItemArray[57]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column59")] != null) rutas.intFactorKmPorGalon = Convert.ToDecimal(dt.Rows[i].ItemArray[58]);

                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column60")] != null) rutas.logEstadoRuta = (bool)(dt.Rows[i].ItemArray[59]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column61")] != null) rutas.ParqueaderoCarretera = Convert.ToDecimal(dt.Rows[i].ItemArray[60]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column62")] != null) rutas.ParqueaderoCiudad = Convert.ToDecimal(dt.Rows[i].ItemArray[61]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column63")] != null) rutas.MontadaLLantaCarretera = Convert.ToDecimal(dt.Rows[i].ItemArray[62]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column64")] != null) rutas.MontadaLLantaCiudad = Convert.ToDecimal(dt.Rows[i].ItemArray[63]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column65")] != null) rutas.AjusteCarretera = Convert.ToDecimal(dt.Rows[i].ItemArray[64]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column66")] != null) rutas.Lavada = Convert.ToDecimal(dt.Rows[i].ItemArray[65]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column67")] != null) rutas.Amarres = Convert.ToDecimal(dt.Rows[i].ItemArray[66]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column68")] != null) rutas.Engradasa = Convert.ToDecimal(dt.Rows[i].ItemArray[67]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column69")] != null) rutas.Calibrada = Convert.ToDecimal(dt.Rows[i].ItemArray[68]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column70")] != null) rutas.Liquidado = (bool)(dt.Rows[i].ItemArray[69]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column71")] != null) rutas.logVacio = (bool)(dt.Rows[i].ItemArray[70]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column72")] != null) rutas.Papeleria = Convert.ToDecimal(dt.Rows[i].ItemArray[71]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column73")] != null) rutas.logFavorito = (bool)(dt.Rows[i].ItemArray[72]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column74")] != null) rutas.CurCargue = Convert.ToDecimal(dt.Rows[i].ItemArray[73]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column75")] != null) rutas.CurDescargue = Convert.ToDecimal(dt.Rows[i].ItemArray[74]);
                if (dt.Rows[19].ItemArray[dt.Columns.IndexOf("Column76")] != null) rutas.LogAnticipoACPM = (bool)(dt.Rows[i].ItemArray[75]);
